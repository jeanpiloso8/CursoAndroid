    ...
    <body>
        ...
        <?php
			if(isset($_POST['user_id']) && isset($_POST['password'])) {
                if($_POST['user_id']=="waltherjoao" && $_POST['password']=="123"){
        ...
        <div class="container">
            ...
            <form class="pure-form pure-form-stacked" method="post">
                <fieldset>
                    ...
                    <input type="text" id="user_id" name="user_id" class="pure-input-1-2" value="">
 
                    <label for="message1">Password</label>
                    <input type="Password" id="Password" name="password" class="pure-input-1-2" value="">

                    <br><br>
                    
                    <input type="hidden" name="push_type" value="topic"/>
                    <button type="submit" class="pure-button pure-button-primary btn_send">Ingresar al sistema</button>
                </fieldset>
            </form>
        </div>
    </body>
